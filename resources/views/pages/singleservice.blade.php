...
<div class="third-menu border-top">
    ...
    <tr>
    <th>
    <div class="fit-popover fit-popover-top fit-tooltip" data-position="top"><span class="fit-popover-content">Source File</span></div>
    </th>
    ...
    <tr>
    <th>
    <div class="fit-popover fit-popover-top fit-tooltip" data-position="top"><span class="fit-popover-content">Commercial Use</span></div>
    </th>
    <td class="boolean-pricing-factor included"></td>
    <td class="boolean-pricing-factor included"></td>
    <td class="boolean-pricing-factor included"></td>
    ...
    <tr>
    <th>
    <div class="fit-popover fit-popover-top fit-tooltip" data-position="top"><span class="fit-popover-content">Interactive Mockup</span></div>
    </th>
    ...
    <tr>
    <th>
    <div class="fit-popover fit-popover-top fit-tooltip" data-position="top"><span class="fit-popover-content"># of Pages / Screens</span></div>
    </th>
    <td>10</td>
    <td>15</td>
    <td>25</td>
    ...
    <tr>
    <th>
    <div class="fit-popover fit-popover-top fit-tooltip" data-position="top"><span class="fit-popover-content">Revisions</span></div>
    </th>
    <td>0</td>
    <td>1</td>
    <td>2</td>
    ...
    <div><input type="hidden" name="gig_items[1][4694800919471][gig_item_id]" value="117210558"><input type="hidden" name="gig_items[1][4694800919471][quantity]" value="0"></div>
    <label class="fake-radio"><input type="radio" name="1" value="0" checked=""><span class="radio-img"></span><span>3 days</span></label>
    <label class="fake-radio">
    <input type="radio" name="1" value="1"><span class="radio-img"></span><span>2 days</span>
    ...
    <td>
    <div class="fake-radio-wrapper">
    <div><input type="hidden" name="gig_items[2][0007284419489][gig_item_id]" value="117210558"><input type="hidden" name="gig_items[2][0007284419489][quantity]" value="0"></div>
    <label class="fake-radio"><input type="radio" name="2" value="0" checked=""><span class="radio-img"></span><span>4 days</span></label>
    <label class="fake-radio">
    <input type="radio" name="2" value="1"><span class="radio-img"></span><span>3 days</span>
    ...
    <td>
    <div class="fake-radio-wrapper">
    <div><input type="hidden" name="gig_items[3][1724678919506][gig_item_id]" value="117210558"><input type="hidden" name="gig_items[3][1724678919506][quantity]" value="0"></div>
    <label class="fake-radio"><input type="radio" name="3" value="0" checked=""><span class="radio-img"></span><span>7 days</span></label>
    <label class="fake-radio">
    <input type="radio" name="3" value="1"><span class="radio-img"></span><span>5 days</span>
