...
<section class="py-5 homepage-search-block position-relative">
    ...
    <h1 class="mb-3 text-shadow text-gray-900 font-weight-bold">Find local professionals for pretty much anything.</h1>
    <h5 class="mb-5 text-shadow text-gray-800 font-weight-normal">Millions of people use exxpert to turn their ideas into reality.
    </h5>
    </div>
    ...
    <div class="col-lg-5">
    <img class="img-fluid" src="{{asset('assets/images/banner.svg')}}" alt='' />
    </div>
    </div>
    </div>
    </section>
    ...
    <li><img src="{{asset('assets/images/mit.png')}}"></li>
    <li><img src="{{asset('assets/images/netflix.png')}}"></li>
    <li><img src="{{asset('assets/images/paypal.png')}}"></li>
    <li><img src="{{asset('assets/images/intuit.png')}}"></li>
     <li><img src="{{asset('assets/images/facebook.png')}}"></li>
    </ul>
