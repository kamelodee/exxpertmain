...
<div class="py-5">
    ...
    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="images/user/s1.png" alt=""></div>
    ...
    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="images/user/s2.png" alt=""></div>
    <div class="font-weight-bold mr-1 overflow-hidden">
    ...
    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="images/user/s3.png" alt=""></div>
    <div class="font-weight-bold mr-1 overflow-hidden">
    ...
    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="images/user/s4.png" alt=""></div>
    <div class="font-weight-bold mr-1 overflow-hidden">
    ...
    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="images/user/s6.png" alt=""></div>
    <div class="font-weight-bold mr-1 overflow-hidden">
    <div class="text-truncate">Bertha Martin
    </div>
    <div class="small text-truncate overflow-hidden text-black-50"><i class="mdi mdi-check text-primary"></i> Pellentesque semper ex diam, at tristique ipsum varius sed. Pellentesque non metus ullamcorper</div>
    ...
    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="images/user/s7.png" alt=""></div>
    <div class="font-weight-bold mr-1 overflow-hidden">
    <div class="text-truncate">Bertha Martin
    </div>
    <div class="small text-truncate overflow-hidden text-black-50"><i class="mdi mdi-check text-primary"></i> Pellentesque semper ex diam, at tristique ipsum varius sed. Pellentesque non metus ullamcorper</div>
    ...
    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="images/user/s8.png" alt=""></div>
    <div class="font-weight-bold mr-1 overflow-hidden">
    <div class="text-truncate">Stacie Hall
    </div>
    <div class="small text-truncate overflow-hidden text-black-50"><i class="mdi mdi-check"></i> Semper ex diam, at tristique ipsum varius sed. Pellentesque non metus ullamcorper</div>
    ...
    <div class="dropdown-list-image mr-3 mb-auto"><img class="rounded-circle" src="images/user/s1.png" alt=""></div>
    <div class="mr-1">
    <div class="text-truncate h6 mb-3">Carl Jenkins
    </div>
    <p>Hi Marie</p>
    <p>welcome to Live Chat! My name is Jason. How can I help you today?
    <a href="#"><span class="__cf_email__" data-cfemail="264f474b4955474e474866414b474f4a0845494b">[email&#160;protected]</span></a>
    </p>
    </div>
    <span class="ml-auto mb-auto">
    <div class="text-right text-muted pt-1 small">00:21PM</div>
    ...
    <div class="d-flex align-items-center osahan-post-header">
    <div class="dropdown-list-image mr-3 mb-auto"><img class="rounded-circle" src="images/user/s2.png" alt=""></div>
    <div class="mr-1">
    ...
    <img src="images/user/s8.png" class="img-fluid rounded-circle shadow-sm" alt="Responsive image">
    </div>
